...
// common render object function. when an object needs to rendered,actor function is used.
...
Enemy.prototype.startY = [68, 151, 234]; // the three enemy starting y axis co ordinates
...
Enemy.prototype.update = function(dt) {
    ...
    // handle collisions of enemy with player
...
Prize.prototype.hitBox = {
    'x': 101,
    'y': 83
};
Prize.prototype.startX = [-2, 99, 200, 301, 402];
Prize.prototype.startY = [83, 166, 249];
